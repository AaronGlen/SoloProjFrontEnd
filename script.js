...
//     }
//     console.log(formDataObj);
//     register(formDataObj, "team");
//     return false;
// }

// function register(formDataObj, table) {

//     const req = new XMLHttpRequest();
//     req.onload = () => {
//         location.href = table+"s.html";
//     };
//     req.open('POST', 'http://35.222.59.218:9000/'+table);
